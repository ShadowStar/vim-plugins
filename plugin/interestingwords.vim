...
let s:interestingWordsGUIColors = ['#B4F2F3', '#33BBC4', '#97FAB9', '#30B633', '#FEFCBA', '#B56E2D', '#FEDBDB', '#B12F26', '#FEDBFE', '#C64AC3', '#74DBFD', '#424CE1']
let s:interestingWordsTermColors = ['LightCyan', 'DarkCyan', 'LightGreen', 'DarkGreen', 'LightYellow', 'DarkYellow', 'LightRed', 'DarkRed', 'LightMagenta', 'DarkMagenta', 'LightBlue', 'DarkBlue']
